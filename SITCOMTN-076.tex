...
%\textbf{Boundary conditions around  must continue to be followed.}
...
Team members are encouraged to present science validation analyses, but the discussion is not intended to include novel scientific results / discoveries until the associated data products have been released via the Early Science Program to the science community.
...
% that have been approved for release.
